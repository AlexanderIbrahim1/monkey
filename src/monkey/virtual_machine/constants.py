...
# set for the number of locals and arguments, but this doesn't (currently) make sense
# because it is in the global scope
#
# the book doesn't address this, and because the book uses Go, I assume it just leaves
# the number of locals and arguments undefined (to the point that I've read, page 200)
#
# I need a dummy values to keep mypy and pyright quiet
DUMMY_MAIN_FUNCTION_NUMBER_OF_LOCALS: int = -1
DUMMY_MAIN_FUNCTION_NUMBER_OF_ARGUMENTS: int = -1
